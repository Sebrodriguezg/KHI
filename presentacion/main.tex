...
\begin{column}{0.65\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{figures/fig_campC_enstrofia_slide.pdf}\figtag
  \end{center}
\end{column}
\end{columns}
\vspace{0.12cm}
...
\begin{column}{0.65\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{figures/fig_campC_ekin_emag_scatter_slide.pdf}\figtag
  \end{center}
\end{column}
\begin{column}{0.33\textwidth}
