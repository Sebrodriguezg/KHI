...
%------------------------------------------------------------------------------
% S2b · INTERLUDIO VISUAL: LA INESTABILIDAD (cap. 3 de la monografía)
%       [plain]; no incrementa la numeración de láminas
%------------------------------------------------------------------------------
{
\setbeamertemplate{footline}{}\setbeamertemplate{headline}{}
\begin{frame}[plain]
  \begin{center}
    \includegraphics[width=0.9\paperwidth,height=0.8\paperheight,
                     keepaspectratio]{figures/KHI_una_interfaz.pdf}\\[4pt]
    {\tiny\color{INF3} La inestabilidad de Kelvin--Helmholtz: dos medios con
     cizalla tangencial ($U_1>U_2$) separados por la interfaz perturbada
     $\eta(x,t)$, que crece a costa de la energ\'ia libre de la cizalla
     (cap.~3 de la monograf\'ia).}
  \end{center}
\end{frame}
...
\vspace{0.05cm}
\begin{center}
  \includegraphics[width=0.30\textwidth]{figures/campana_A_3d.pdf}\figtag\hfill
  \includegraphics[width=0.30\textwidth]{figures/campana_B_3d.pdf}\figtag\hfill
  \includegraphics[width=0.30\textwidth]{figures/campana_C_3d.pdf}\figtag
\end{center}
\end{frame}
...
\begin{column}{0.50\textwidth}
  \vspace*{0.85cm}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/glm_limpieza.pdf}\figtag\\[2pt]
...
\begin{column}{0.48\textwidth}
  \begin{center}
    \includegraphics[width=0.9\linewidth]{figures/celda_3d_flujos.pdf}\figtag\\[2pt]
...
\begin{column}{0.44\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/riemann_hll.pdf}\figtag
  \end{center}
  \vspace{-0.1cm}
...
\begin{column}{0.46\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/imex_splitting_slide.pdf}\figtag\\[2pt]
...
\begin{center}
  \includegraphics[width=0.98\textwidth]{figures/fig_global_campos_transitorio.pdf}\figtag
\end{center}
\vspace{-0.12cm}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
\begin{column}{0.50\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/fig_campA_enstrofia_slide.pdf}\figtag
  \end{center}
  \vspace{-0.1cm}
...
\begin{column}{0.48\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/fig_campB_omegamax_theta_slide.pdf}\figtag
  \end{center}
  \vspace{-0.1cm}
...
\begin{column}{0.52\textwidth}
  \begin{center}
    \includegraphics[height=0.60\textheight]{figures/fig_campC_enstrofia_slide.pdf}\figtag
  \end{center}
  \vspace{-0.2cm}
...
\begin{column}{0.44\textwidth}
  \begin{center}
    \includegraphics[height=0.60\textheight]{figures/fig_campC_ekin_emag_scatter_slide.pdf}\figtag
  \end{center}
  \vspace{-0.2cm}
