...
\begin{column}{0.55\textwidth}
  \begin{center}
    \includegraphics[height=0.33\textheight]{figures/velocidad_inicial.pdf}\\[1pt]
    \includegraphics[height=0.33\textheight]{figures/rho_inicial.pdf}\\[2pt]
...
\begin{column}{0.60\textwidth}
  \begin{center}
    \includegraphics[height=0.78\textheight]{figures/fig_conductividad_rho_collage.pdf}
  \end{center}
\end{column}
...
\begin{column}{0.60\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/ln_omega_vs_t.pdf}
  \end{center}
\end{column}
\begin{column}{0.38\textwidth}
...
\begin{column}{0.50\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/fig_campA_enstrofia.pdf}
  \end{center}
  \vspace{-0.1cm}
...
\begin{column}{0.48\textwidth}
  \begin{center}
    \includegraphics[width=\linewidth]{figures/fig_campB_omegamax_theta.pdf}
  \end{center}
  \vspace{-0.1cm}
...
\begin{column}{0.55\textwidth}
  \begin{center}
    \includegraphics[height=0.72\textheight]{figures/fig_campB_ekin_emag_scatter.pdf}\\[2pt]
    {\tiny\color{INF3} Parte oscilatoria de $E_{\rm kin}$ vs.\ $E_{\rm mag}$
     por \'angulo: anti-correlaci\'on $r\simeq-0.6$ a $-0.9$ (Campa\~na B).}
  \end{center}
\end{column}
\begin{column}{0.43\textwidth}
