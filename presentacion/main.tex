...
\begin{column}{0.46\textwidth}
  ...
  \only<3>{%
  \begin{center}
    \includegraphics[height=0.62\textheight]{figures/khi_rho_snapshot_slide.pdf}\\[4pt]
    {\tiny\color{INF3} La KHI en nuestras simulaciones: densidad $\rho(x,y)$
     ($\sigma=1000$, $t=8$) --- la interfaz ya enrollada en v\'ortices.}
  \end{center}}%
  \only<4>{%
  \begin{center}
    \vspace{0.25cm}
    \includegraphics[width=0.96\linewidth]{figures/khi_clouds_photo.jpg}\\[4pt]
    {\tiny\color{INF3} La KHI en el cielo: nubes Kelvin--Helmholtz reales
     (foto: Astronautilus, Wikimedia Commons, CC~BY~2.0).}
  \end{center}}%
\end{column}
\end{columns}
\end{frame}
...
%------------------------------------------------------------------------------
\begin{frame}{M\'etodo Num\'erico: FV de Alto Orden $+$ IMEX $+$ Primitivas Anal\'iticas}
...
\begin{column}{0.52\textwidth}
  \begin{tcolorbox}[EQ={Volumenes finitos (forma integral)}]
    ...
    \[
      ...
      +\bar{\mathbf S}_i
    \]
    Admite \textbf{choques} (soluciones d\'ebiles, Rankine--Hugoniot) y la
    conservaci\'on es \textbf{exacta por construcci\'on} \citep{toro-2009}.
  \end{tcolorbox}
  \pause
  ...
  {\tiny
   ...
   barrido ($\sigma\le10\,500$). \hfill[detalle: resp.\ B14--B17]}
\end{column}
\begin{column}{0.44\textwidth}
  \pause
  \begin{center}
    \includegraphics[width=0.62\linewidth]{figures/celda_3d_flujos.pdf}\figtag\\[3pt]
    \includegraphics[width=0.97\linewidth]{figures/imex_flow_slide.pdf}\figtag
  \end{center}
  \vspace{-0.04cm}
  {\tiny
   \textbf{IMEX} (ecuaci\'on en l\'amina 9): la fuente r\'igida
...
%------------------------------------------------------------------------------
% S24b · MORFOLOGÍA CAMPAÑA B (movida del respaldo B12 en ronda 2)
%------------------------------------------------------------------------------
...
\begin{column}{0.50\textwidth}
  \begin{center}
    \includegraphics[width=0.90\linewidth]{figures/fig_campA_enstrofia_slide.pdf}\figtag
  \end{center}
  \pause\vspace{-0.1cm}
...
\begin{column}{0.48\textwidth}
  \pause
  \begin{center}
    \includegraphics[width=0.90\linewidth]{figures/fig_campB_omegamax_theta_slide.pdf}\figtag
  \end{center}
  \pause\vspace{-0.1cm}
...
\begin{columns}[T]
\begin{column}{0.48\textwidth}
  {\tiny\color{accent}\textbf{$\blacktriangleright$ En referencia al Objetivo 1:}
  ...
  \end{tcolorbox}
  \pause\vspace{0.08cm}
  {\tiny\color{accent}\textbf{$\blacktriangleright$ En referencia al Objetivo 2:}
...
\begin{column}{0.48\textwidth}
  \pause
  {\tiny\color{accent}\textbf{$\blacktriangleright$ En referencia al Objetivo 3:}
  ...
  \end{tcolorbox}
  \pause\vspace{0.08cm}
  {\tiny\color{accent}\textbf{$\blacktriangleright$ En referencia al Objetivo 4:}
...
\begin{center}
  ...
  {\color{gold}\small B1--B17: derivaciones, validaciones y an\'alisis complementarios}
\end{center}
\end{frame}
}
