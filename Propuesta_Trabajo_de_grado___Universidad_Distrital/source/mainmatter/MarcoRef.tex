\section{Ecuaciones de la Magnetohidrodinámica Resistiva Relativista}
...
El sistema completo de ecuaciones que gobierna la evolución del plasma se puede escribir como: \ser{(ojo! estamos utilizando la notación de Valencia (así se conoce) por sí en algun momento les preguntan el porque del factor de lorentz como $W$, el momentum como $S$ y la densidad de masa conservada como $D$)}
\begin{center}
