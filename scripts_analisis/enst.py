...
# Directorios según el log original
CLEAN = "/home/sebastian/Documents/Grado/INFO/lab/analisis_campanas_B_PRELIM/resultados_condensados_6000_vs_10000/ANALISIS_LIMPIO_FINAL/DATOS_LIMPIOS"
FIG = "/home/sebastian/Documents/Grado/REPO_GH/monografia/figuras"
...
def thlbl(nm): 
    # Devuelve el string ya con los signos $ incluidos
    ang = nm.split("_th")[-1]
...
def combo(fam, fname, titulo, lblfn):
    ...
    for ax, (sg, cfl) in zip(axs, [("sigma6000", "0.04"), ("sigma10000", "0.02")]):
        for r in sorted(glob.glob(os.path.join(CLEAN, fam, sg, "run_*"))):
            ...
            # CORRECCIÓN: Quitamos el $ extra del f-string, lblfn ya trae los $
        ...
        # CORRECCIÓN: Usamos rf"" para evitar el warning de escape \s en \sigma
...
# Generación para Campaña C
combo("C_orientacion_xz", "fig_campC_enstrofia", 
      r"Campaña C (plano $x$–$z$) — enstrofía $\Omega_{zp}(t)$ vs orientación $\theta$", thlbl)