...
Aunque la introducción del campo $\Phi$ resuelve de manera elegante las patologías del sector eléctrico, el formalismo lagrangiano basado exclusivamente en el potencial $A_\mu$ deja intacta la identidad de Bianchi, $\partial_\mu {}^*F^{\mu\nu} = 0$. Matemáticamente, al definir el tensor de Faraday como la derivada exterior exacta del potencial ($F=dA$), la ausencia de monopolos magnéticos ($dF=0$) constituye una restricción topológica inquebrantable en el límite continuo. 
...
Esta separación define unívocamente un escalar invariante de Lorentz y un vector puramente espacial en el marco propio del fluido. Se define la densidad de carga propia $\rho_e$ como la contracción directa de la corriente con la cuadrivelocidad:
$$\rho_e \equiv -J^\nu u_\nu$$
...
\begin{equation}
    \ln \Omega'z(t) = C + 2\gamma{\text{KHI}}t.
\end{equation}
