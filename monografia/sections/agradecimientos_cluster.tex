...
\prof{deberian separar esto en dos capitulos por un lado los recursos computacionales y por otro los agradecimientos, donde obviamente deberían agradecer al profesor por facilitarles el codigo \textbf{cueva} y su invaluable orientación ;), agradecer a sus familiares y compañeros y tambien a quien les ha dado acceso al servidor (universidad o investigador), tambien una agradecimientoa la UD por la formación que les ha brindado .... etc}
