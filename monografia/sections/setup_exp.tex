...
(Tabla~\ref{tab:canonica_sigma}). La transición entre regímenes se caracteriza dimensionalmente mediante el número de Lundquist local $S = L_0 V_A / \eta$, donde $V_A$ es la velocidad de Alfvén local evaluada con las cantidades iniciales. Para los valores de $\sigma$ aquí explorados, $S$ varía a lo largo de varios órdenes de magnitud, permitiendo identificar la conductividad crítica $\sigma_{\text{crit}}$ por encima de la cual la dinámica reproduce asintóticamente los resultados de la MHD ideal y por debajo de la cual la difusión resistiva domina sobre la advección magnética.\sebnota{Falta poner el espacio de parámetros dictado por la campaña de campo magnético, en $\sigma=6000$ y $\sigma=10000$.}\claudenota{Pendiente de los datos de la campaña (martes). Marcador: al llegar, tabular los $\sigma$ usados (6000, 10000), las orientaciones/intensidades de $\mathbf B$ y el CFL de cada corrida.}
