...
\primerparrafo Se detalla el paso ---resumido en el cuerpo (Sección~\ref{sec:Elec_Cov})--- desde la definición geométrica $F\equiv dA$ hasta sus componentes covariantes. Sustituyendo el cuadripotencial $A = A_\nu dx^\nu$ y aplicando la regla de Leibniz para la derivada exterior:
\begin{align}
    dA &= d(A_\nu dx^\nu) \nonumber \\
       &= dA_\nu \wedge dx^\nu + A_\nu d(dx^\nu)
\end{align}
