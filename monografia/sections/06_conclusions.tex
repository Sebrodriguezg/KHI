...
\item \textbf{Esquemas \prof{de integración temporal} de orden aún mayor:} (p.ej.\ cuarto orden, \parencite{mignone2024}) para reducir la disipación numérica y resolver las hojas resistivas.
\end{itemize}
