...
\begin{itemize}
\item \textbf{Campaña de campo magnético (objetivo 4):}\sebnota{no es válido: ya no es ``trabajo futuro'', la campaña está en curso.} barrido de intensidad y orientación de $\mathbf B$ para mapear la estabilización por tensión magnética.
