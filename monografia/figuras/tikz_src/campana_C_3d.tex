...
% --- campo: orientacion x-z (rota de z a x) ---
\foreach \t in {0,30,60,90}{
  \pgfmathsetmacro\sx{1.7*sin(\t)}\pgfmathsetmacro\cz{1.7*cos(\t)}
  \draw[->,red!60,opacity=0.6,thick] \PT{0}{0}{0} -- \PT{\sx}{0}{\cz};
}
\pgfmathsetmacro\sxb{1.7*sin(50)}\pgfmathsetmacro\czb{1.7*cos(50)}
\draw[Bvec] \PT{0}{0}{0} -- \PT{\sxb}{0}{\czb};
\node[red!75!black,font=\footnotesize] at \PT{1.3}{0}{1.3} {$\mathbf B$};
\node[red!60,font=\scriptsize] at \PT{1.95}{0}{0.15} {$\theta{=}90^\circ$};
\node[font=\bfseries] at \PT{0}{0.3}{2.75} {Campaña C: orientación $x$--$z$};
\node[font=\scriptsize,align=center] at \PT{0}{0}{-1.2}
  {$\mathbf B$ rota en el plano $x$--$z$; $B_x\!\perp\!\mathbf k$, $B_y{=}0$\\ $\Rightarrow$ $\mathbf k\!\cdot\!\mathbf B{=}0$, sin tensión};
\end{tikzpicture}
\end{document}
